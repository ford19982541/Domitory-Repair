      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            <Text textStyle={{ minHeight: 70 }} label="ปัญหา/อาการ">
            ...
            <Text textStyle={{ minHeight: 70 }} label="สถานะ">
              สถานะ:{" "}
              {data.status == 1
                ? "แจ้งซ่อม"
                : data.status == 2
            ...
            <Text textStyle={{ minHeight: 70 }} label="วันที่แจ้งซ่อม">
              วันที่แจ้งซ่อม: {data.created_date}
            </Text>

            <Text textStyle={{ minHeight: 70 }} label="วันที่อนุมัติ">
              วันที่อนุมัติ: {data.wait_date}
            </Text>

            <Text textStyle={{ minHeight: 70 }} label="วันที่อนุมัติรายการ">
            ...
            <Text textStyle={{ minHeight: 70 }} label="หมายเหตุ">
              หมายเหตุ: {data.note}
            </Text>

            <Text textStyle={{ minHeight: 70 }} label="ประเภท">
              ประเภท:{" "}
              {data.repair_type == 1
                ? "ไฟฟ้า"
                : data.repair_type == 2
            ...
            <Text textStyle={{ minHeight: 70 }} label="หมายเลขห้อง">
